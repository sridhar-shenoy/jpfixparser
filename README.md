...
* Approximately **600,000** messages per sec with around ~**50K** constant memory through out the lifecycyle 
* Fix Message parser that has **Zero garbage** if used with our recommended best practice. ( benchmark displayed below )
